...
Public Class rptPackedCartonDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "DecisionsMIS.rptPackedCartonDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPackedCartonDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPackedCartonDetails = New rptPackedCartonDetails
        rpt.Site = Me.Site
        Return rpt
    End Function
