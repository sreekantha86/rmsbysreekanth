...
Public Class rptPackingListReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "iHitsERP.rptPackingListReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPackingListReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPackingListReport = New rptPackingListReport
        rpt.Site = Me.Site
        Return rpt
    End Function
